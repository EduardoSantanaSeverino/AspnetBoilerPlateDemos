...
{
    public abstract class MyCollegeV2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyCollegeV2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyCollegeV2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyCollegeV2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyCollegeV2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyCollegeV2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyCollegeV2DbContext, Task<T>> func)
        {
            T result;
